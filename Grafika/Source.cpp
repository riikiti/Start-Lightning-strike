...
#pragma endregion
	...
	byte* data = stbi_load("img\\box.png", &box_width, &box_height, &channels, 0);
...
#pragma endregion
	...
	Shader* polygon_shader = new Shader("basic.vert", "basic.frag");
	Shader* light_shader = new Shader("light.vert", "light.frag");
	Shader* backpack_shader = new Shader("backpack.vert", "backpack.frag");
